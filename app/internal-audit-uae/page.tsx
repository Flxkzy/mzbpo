// app/internal-audit-uae/page.tsx
"use client"
...
import { TestimonialsAuditUAE } from "@/components/demos/TestimonialsauditUAE"
import Footer from "@/components/footer"
import { CTASection } from "@/components/cta-section"
import { FAQAuditUAE } from "@/components/FaqauditUAE"
...
// ============================================
// INTERNAL AUDIT UAE PAGE DATA
// ============================================

// Problems/Scenarios for Internal Audit - UAE
const INTERNAL_AUDIT_SCENARIOS = [
  ...
  {
    category: "The FTA Question",
    question: "FTA sent a review request. Are we actually compliant with Corporate Tax and VAT? Or have we just been hoping we are?",
...
export default function InternalAuditUAEPage() {
  return (
    <main className="relative min-h-screen bg-brand-navy text-white overflow-x-hidden">
      ...
      <div className="relative z-10 pt-20 sm:pt-24 lg:pt-28">
        ...
        {/* ============================================ */}
        {/* HERO - Internal Audit UAE Version */}
        {/* ============================================ */}
        <section className="mt-6">
          <HeroSection
            eyebrow="Exclusively For Businesses..."
            starsSubtext="Trusted by leading companies across UAE, Saudi Arabia and UK"
            headline={
              <>
                Get <span className="text-[rgba(98,198,161,1)]">Independent Internal Audit, Control Testing, & Compliance Oversight</span> For Your Business, So Every Dirham Is Accounted For and You're Always Ready for External Audits or FTA Reviews
              </>
            }
        ...
        {/* ============================================ */}
        {/* SOCIAL PROOF - Internal Audit UAE Version */}
        {/* ============================================ */}
        <ClientShowcase
          ...
          subheadline="Independent internal audit services for growing UAE companies. Backed by BKR International, the world's 5th largest accounting association."
          stats={[
              ...
              <div className="relative z-10 p-8 md:p-12 flex flex-col md:flex-row items-center gap-10">
                ...
                <div className="w-full md:w-2/3 font-[var(--font-poppins)]">
                  ...
                  <p className="text-base md:text-lg text-gray-300 font-[var(--font-poppins)] leading-relaxed">
                    ...
                    —we bring international audit standards to your UAE business.
                    <br /><br />
        ...
        {/* ============================================ */}
        {/* TESTIMONIALS - Internal Audit UAE Version */}
        {/* ============================================ */}
        <section id="testimonials">
          <TestimonialsAuditUAE />
        </section>

        <FAQAuditUAE/>

        {/* ============================================ */}
        {/* FINAL CTA - Internal Audit UAE Version */}
        {/* ============================================ */}
        <CTASection
          headline="Get confidence in your numbers."
          highlightedText="Be ready for any audit."
          bodyText="Whether you're preparing for external audits, FTA reviews, or just want to know your controls are working—we help you replace uncertainty with independent oversight and clear reporting."
          ctaText="Schedule a consultation"
          ctaLink="/meeting"
          trackingContentName="CTA Section - Internal Audit UAE Consultation"
        />
