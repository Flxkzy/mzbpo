...
const testimonials: Testimonial[] = [
  ...
  },
  {
    ...
    image: "/images/2.avif",
    quote:
      "We had no idea how many control gaps existed until they conducted a full internal audit. The clarity we gained was worth every riyal.",
    highlight: "12",
  ...
  },
  {
    ...
    image: "/images/3.avif",
    quote:
      "ZATCA sent a review request and for the first time, we were ready. Documentation was complete, controls were tested, and we passed without issues.",
    highlight: "100%",
    highlightLabel: "ZATCA compliance achieved",
  },
  {
    id: 4,
    name: "CEO",
...
export function TestimonialsAudit() {
    ...
    <section className="py-20 md:py-28 px-4 font-[var(--font-poppins)]" style={{ backgroundColor: "hsl(232 45% 15%)" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-12 flex flex-wrap justify-center gap-6 md:gap-10">
          ...
          <div className="flex items-center gap-2 text-white/60">
            <CheckCircle className="w-5 h-5 text-brand-teal" />
            <span className="text-sm">Saudi regulatory compliance</span>
          </div>
        </div>
