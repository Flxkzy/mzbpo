...
const faqs: FAQ[] = [
  {
    ...
    answer: "Internal audit isn't about size, it's about complexity and risk. If you're growing, handling more transactions, and have more people touching finances, you need oversight. The gaps that form at your stage compound quickly. Fixing them now is easier and cheaper than fixing them after your external auditor flags them or the FTA comes asking questions.",
  },
  {
  ...
  },
  {
    ...
    answer: "That's exactly why you hire us, to find problems before someone else does. We report what we find clearly and help you prioritize fixes based on risk. Finding a control gap with us is infinitely better than having your external auditor flag it, the FTA discover it, or, worst case, finding out through actual financial loss.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. We work with companies in the UAE, Saudi Arabia, USA and UK. Our team operates remotely with secure systems, and as a BKR International partner, we apply global audit standards regardless of location.",
  },
]

export function FAQAuditUAE() {
