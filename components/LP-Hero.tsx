...
export default function HeroSection({
  ...
  return (
    <section className="relative w-full flex flex-col items-center justify-start pt-8 sm:pt-12 md:pt-16 pb-20 sm:pb-24 md:pb-28 px-4 md:px-6 overflow-hidden text-white">
      <div className="relative z-10 max-w-5xl mx-auto text-center flex flex-col items-center">
        
        {/* Eyebrow */}
        <motion.div initial="hidden" animate="visible" variants={fadeInUp} className="mb-5 sm:mb-6">
          <span className="inline-block py-2 px-5 rounded-full bg-[rgba(98,198,161,0.1)] border border-[rgba(98,198,161,0.3)] text-white text-xs sm:text-sm font-sans font-semibold tracking-wide">
            {eyebrow}
          </span>
        </motion.div>
        ...
        <motion.h1
          ...
          variants={fadeInUp}
          custom={0.1}
          className="font-[family-name:var(--font-syne)] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-[1.2] max-w-4xl mx-auto"
        >
          {headline}
        </motion.h1>
        ...
        <motion.p
          ...
          variants={fadeInUp}
          custom={0.15}
          className="mt-6 sm:mt-8 font-sans text-base sm:text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed"
        >
          {subheadline}
        </motion.p>
